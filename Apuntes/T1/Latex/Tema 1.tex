...
\begin{document}
	...
	\noindent Suponiendo que la fuente emite de forma uniforme (aproximación), esto es que $I_S(\xi, \eta)=I_0$. Si nos centramos en la dirección $x$, la integral quedaría y la solución sería la función de Bessel
