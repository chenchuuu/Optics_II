...
\begin{document}
	...
	\subsubsection{Caso particular: fuente puntual monocromática y abertura}
	...
	Si el número de Fresnel es mucho menor que la unidad ($10^{-3}$ como máximo), podemos aplicar la aproximación de Fraunhöfer con seguridad. La zona intermedia entre $10^{-3}$ y la unidad sería la frontera entre ambas aproximaciones. Si $F$ es mayor o igual que la unidad, estamos en \textit{difracción de Fresnel o de campo cercano}, con lo cual los cálculos de la distribución de amplitudes o intensidad en el plano de observación se complican bastante, y vamos a desarrollar este caso sólo con un par de ejemplos al final del tema.
